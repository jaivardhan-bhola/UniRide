        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Center(
                child: Text('Bus', style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 30))
                ),
              ),
            ),
            SizedBox(height: 49),
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text('Search for Bus Routes', style: GoogleFonts.montserrat(textStyle: TextStyle(fontSize: 20, color: Colors.white))),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextField(
            ...
            Image.asset('assets/Bus.png', height: MediaQuery.of(context).size.height * 0.3),
            SizedBox(height: 20),
          ],
        ),
      ),
